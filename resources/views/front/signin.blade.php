	            ...
	            <div class="row">
	                <div class="col-md-6 offset-md-3 col-lg-6 offset-lg-3">
	                	<div class="nk-box-2 bg-dark-2" >
	                    	<h3 class="mb-0"><span class="text-main-1">Sign</span> In</h3>

			                <div class="nk-gap-1"></div>
			                <form method="post" action="/login" class="nk-form text-white">
			                	@csrf
			                    ...
			                    <div class="row vertical-gap">
			                        <div class="col-md-6">
			                            <button type="submit" class="nk-btn nk-btn-rounded nk-btn-color-white nk-btn-block">	Sign In
			                            </button>
			                        </div>
			                        <div class="col-md-6">
			                            <div class="mnt-5">
